...
class QuestionAnswersControllerTest < ActionController::TestCase
  ...
  test "should create question_answer" do
    assert_difference('QuestionAnswer.count') do
      post :create, question_answer: { label: @question_answer.label, question_id: @question_answer.question_id, value: @question_answer.value }
    end
  ...
  test "should update question_answer" do
    put :update, id: @question_answer, question_answer: { label: @question_answer.label, question_id: @question_answer.question_id, value: @question_answer.value }
    assert_redirected_to question_answer_path(assigns(:question_answer))
  end
