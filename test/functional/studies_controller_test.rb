...
class StudiesControllerTest < ActionController::TestCase
  ...
  test "should create study" do
    assert_difference('Study.count') do
      post :create, study: { abstract: @study.abstract, label: @study.label, name: @study.name, universe: @study.universe }
    end
  ...
  test "should update study" do
    put :update, id: @study, study: { abstract: @study.abstract, label: @study.label, name: @study.name, universe: @study.universe }
    assert_redirected_to study_path(assigns(:study))
  end
