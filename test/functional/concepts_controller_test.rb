...
class ConceptsControllerTest < ActionController::TestCase
  ...
  test "should create concept" do
    assert_difference('Concept.count') do
      post :create, concept: { abstract: @concept.abstract, concept_group_id: @concept.concept_group_id, label: @concept.label, name: @concept.name }
    end
  ...
  test "should update concept" do
    put :update, id: @concept, concept: { abstract: @concept.abstract, concept_group_id: @concept.concept_group_id, label: @concept.label, name: @concept.name }
    assert_redirected_to concept_path(assigns(:concept))
  end
