...
class VariablesControllerTest < ActionController::TestCase
  ...
  test "should create variable" do
    assert_difference('Variable.count') do
      post :create, variable: { label: @variable.label, name: @variable.name, physical_data_product_id: @variable.physical_data_product_id, variable_group_id: @variable.variable_group_id }
    end
  ...
  test "should update variable" do
    put :update, id: @variable, variable: { label: @variable.label, name: @variable.name, physical_data_product_id: @variable.physical_data_product_id, variable_group_id: @variable.variable_group_id }
    assert_redirected_to variable_path(assigns(:variable))
  end
