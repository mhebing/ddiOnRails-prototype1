...
class QuestionnairesControllerTest < ActionController::TestCase
  ...
  test "should create questionnaire" do
    assert_difference('Questionnaire.count') do
      post :create, questionnaire: { abstract: @questionnaire.abstract, data_collection_id: @questionnaire.data_collection_id, label: @questionnaire.label, name: @questionnaire.name }
    end
  ...
  test "should update questionnaire" do
    put :update, id: @questionnaire, questionnaire: { abstract: @questionnaire.abstract, data_collection_id: @questionnaire.data_collection_id, label: @questionnaire.label, name: @questionnaire.name }
    assert_redirected_to questionnaire_path(assigns(:questionnaire))
  end
